...
const SCHEMA = [
  ...
  { key: 'scanIntervalSec', group: 'Engine', type: 'int', default: 60, min: 15, max: 900,
    ...
    label: 'Run both engines (paper A/B)', help: 'STRUCTURE and TREND scan side by side. Trades tagged with engine. Per-engine position soft-cap = maxOpen/2.' },
...
{ key: 'entryWindowMin', group: 'Entry', type: 'int', default: 45, min: 5, max: 480,
  ...
  { key: 'maxOpenPositions', group: 'Risk', type: 'int', default: 5, min: 1, max: 50, label: 'Max open positions' },
